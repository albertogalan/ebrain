...
CKEDITOR.editorConfig = function(config) {
    ...
    del[datetime, title]; \
    span[*](math-tex,original,translate,cost,information,jieba,line);a[!href];h1; h2; h3; h4; h5; \
    b; \
    a[id]; br;code {*};pre;section; \
    p div [value] (converted,page,original,translate,videolink,jieba,ieconomics_share,path,savetofile,chinese,marco,marco_desc,img_desc,section_desc,tabs,tab,content,middle);\
    p (converted); \
    ...
    //     },
    //     span: {
    //         classes: ['jieba','line','math-tex', 'original', 'translate', 'cost', 'information'],
    //     },
    //     span: {
    //         styles: 'background'
    //     },
    ...
    //     'p div': { classes: ['page','original', 'translate', 'videolink', 'jieba', 'ieconomics_share', 'path', 'savetofile', 'chinese', 'marco', 'marco_desc', 'img_desc', 'section_desc', 'tabs', 'tab', 'content', 'middle'] },
