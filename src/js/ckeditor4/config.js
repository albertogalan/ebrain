...
CKEDITOR.editorConfig = function(config) {
    ...
    p div [value] (page,original,translate,videolink,jieba,ieconomics_share,path,savetofile,chinese,marco,marco_desc,img_desc,section_desc,tabs,tab,content,middle);\
